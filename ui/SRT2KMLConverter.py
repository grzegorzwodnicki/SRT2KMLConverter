...
################################################################################
## Form generated from reading UI file 'SRT2KMLConverter.ui'
##
...
class Ui_SRT2KMLConverter(object):
    def setupUi(self, SRT2KMLConverter):
        if not SRT2KMLConverter.objectName():
            SRT2KMLConverter.setObjectName(u"SRT2KMLConverter")
        SRT2KMLConverter.resize(948, 436)
        self.centralwidget = QWidget(SRT2KMLConverter)
        ...
        self.btnKML = QCheckBox(self.hlOptions_2)
        self.btnKML.setObjectName(u"btnKML")
        self.btnKML.setMinimumSize(QSize(84, 36))
        self.btnKML.setMaximumSize(QSize(84, 36))
        ...
        self.btnJSON.setMinimumSize(QSize(120, 36))
        ...
        self.lblVersion = QLabel(self.vlVersion)
        self.lblVersion.setObjectName(u"lblVersion")
        font1 = QFont()
        self.lblVersion.setFont(font1)
        self.lblVersion.setStyleSheet(u"font-size:14px; \n"
"color: #676767; \n"
"text-align: bottom left;")
        self.lblVersion.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
        ...
        QMetaObject.connectSlotsByName(SRT2KMLConverter)
    # setupUi

    def retranslateUi(self, SRT2KMLConverter):
        SRT2KMLConverter.setWindowTitle(QCoreApplication.translate("SRT2KMLConverter", u"SRT/KML Converter", None))
        self.lblTitle.setText(QCoreApplication.translate("SRT2KMLConverter", u"SRT/KML Converter", None))
        self.lblLogo.setText("")
        self.btnClose.setText("")
        self.lblSource.setText(QCoreApplication.translate("SRT2KMLConverter", u"Source File:", None))
        self.btnChooseSource.setText("")
        self.lblOutput.setText(QCoreApplication.translate("SRT2KMLConverter", u"Output File:", None))
        self.btnChooseOutput.setText("")
        self.lblOutputoption.setText(QCoreApplication.translate("SRT2KMLConverter", u"Output File:", None))
        self.btnKML.setText(QCoreApplication.translate("SRT2KMLConverter", u"KML", None))
        self.btnKMZ.setText(QCoreApplication.translate("SRT2KMLConverter", u"KMZ", None))
        self.btnGPX.setText(QCoreApplication.translate("SRT2KMLConverter", u"GPX", None))
        self.btnJSON.setText(QCoreApplication.translate("SRT2KMLConverter", u"GeoJSON", None))
        self.progressBar.setFormat(QCoreApplication.translate("SRT2KMLConverter", u"%p%   ", None))
        self.lblVersion.setText(QCoreApplication.translate("SRT2KMLConverter", u"Ver 1.10", None))
        self.btnStart.setText(QCoreApplication.translate("SRT2KMLConverter", u"Start", None))
        self.toolButton.setText(QCoreApplication.translate("SRT2KMLConverter", u"Usri.ca", None))
    # retranslateUi
